...
from jinja_to_another import Converter
...
def convert(converter, template, output):
    ...
    Примеры вызова команды:
      ...
      jinja2another convert -g django -o out/base.html base.html

      jinja2another convert -g django -o out base.html

      jinja2another convert -g django base.html


      JINIA_TO_ANOTHER_CONFIG=config.py jinja2another convert -g django -o out base.html

      cat base.html | jinja2another convert -g django -o out.html

      cat base.html | jinja2another convert -g django
    """
